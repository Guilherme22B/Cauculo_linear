...
class sistem:
    ...
    def executar():
        ...
        A, B = dados
        sistem.imprimir_sistema(A, B, "Sistema original:")

        A_esc, B_esc = sistem.escalonar(A.copy(), B.copy())
        sistem.imprimir_sistema(A_esc, B_esc, "Sistema escalonado:")

        resultado = sistem.resolver_sistema(A_esc, B_esc)
